...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `arm64-v8a`         | [Download Providra for 64-bit Android devices](https://github.com/dtankdempsey2/Providra/releases/download/v0.1.0-beta.5/providra-v0.1.0-beta.5-arm64-v8a.apk)   |
| `armeabi-v7a`       | [Download Providra for 32-bit Android devices](https://github.com/dtankdempsey2/Providra/releases/download/v0.1.0-beta.5/providra-v0.1.0-beta.5-armeabi-v7a.apk) |
